...
\begin{equation}
\begin{split}
    \theta^{\ast} \;=\; \operatorname*{arg\,min}_{\theta^{\ast}}\;J(D, \theta) \;=\; \operatorname*{arg\,min}_{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr)
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
    \theta^{\ast}(\epsilon) \;=\; \operatorname*{arg\,min}_{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr) + \epsilon\mathcal{L}\bigl(z_m, \theta\bigr)
\end{split}
\end{equation}
...
Here, $\left.\frac{d\,\theta^{\ast}(\epsilon)}{d\epsilon}\right|_{\epsilon=0}$ captures the influence of the datum $z_m$ on $\theta^{\ast}$.
