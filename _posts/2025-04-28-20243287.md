...
\begin{equation}
P(y_i = x_i | \psi = 1, x) = P(y_i = x_i | x_{\ i}).
\end{equation}
...
\begin{equation}
\begin{split}
P(y_i = x_i | x_{\ i}, \theta) =frac{\alpha + \beta}{\alpha} P(y_i = x_i | x, \theta) - \frac{\beta}{\alpha}, 
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\theta^{\ast} \;=\; \argmin_{\theta^{\ast}}\;J(D, \theta) \;=\; \argmin_{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr)
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\theta^{\ast}(\epsilon) \;=\; \argmin_{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr) + \epsilon\mathcal{L}\bigl(z_m, \theta\bigr)
\end{split}
\end{equation}
...
\end{equation}
where $\left.\frac{d\,\theta^{\ast}(\epsilon)}{d\epsilon}\right|_{\epsilon=0}$ captures the influence of the datum $z_{m}$ on $\theta^{\ast}$.
...
\,H^{-1}\,
\nabla_{\theta}\mathcal{L}\bigl(z_{m},\,\theta^{\ast}\bigr)\,.\end{split}
\end{equation}
