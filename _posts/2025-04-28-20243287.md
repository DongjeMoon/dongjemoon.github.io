...
\begin{equation}
\begin{split}
\theta^{\ast} \;=\; \operatorname*{arg\,min}{\theta^{\ast}}\;J(D, \theta) \;=\; \operatorname*{arg\,min}{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr)
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\theta^{\ast}(\epsilon) \;=\; \operatorname*{arg\,min}{\theta^{\ast}}\;\frac{1}{N}\sum_{i=1}^{N} \mathcal{L}\bigl(z_i, \, \theta\bigr) + \epsilon\mathcal{L}\bigl(z_m, \theta\bigr)
\end{split}
\end{equation}
