...
<figure style="display: flex; flex-direction: column; align-items: center;">
  <iframe style="width: 100%; height: 200px; border: 0;" src="{{ 'assets/html/2025-04-28-20243287/space.html#loop1' | relative_url }}" frameborder="0" scrolling="no"></iframe>
  <figcaption class="caption">
...
$\theta^{*}(\epsilon)$ can be expressed as: $\theta^{*}(\epsilon) \;=\; \theta^{*}(0) + \epsilon \cdot \frac{d\theta^{*}(\epsilon)}{d\epsilon}\;\left|\right._{\epsilon=0}$, 
