...
\begin{split}
s_{\mathbf{k}} 
&= \sum_{j} h_{j}\,\exp\bigl(-i\,\mathbf{k}\!\cdot\!\mathbf{x}_{j}\bigr)\,.
\end{split}
\end{equation}
...
\begin{split}
M_i^{\mathrm{lr}}
&= \sum_{\mathbf{k}} \widehat{M}^{\mathrm{lr}}(\mathbf{k})\;e^{\,i\,\mathbf{k}\cdot \mathbf{x}_i}\,,
\end{split}
\end{equation}
